package com.digitalsoftware.accounting.configuration.filter;

import com.digitalsoftware.accounting.services.facade.LogService;
...
//        beforeRequest(wrapRequest(request), wrapResponse(response));
...
//        }
    ...
    protected void doFilterWrapped(ContentCachingRequestWrapper request, ContentCachingResponseWrapper response, FilterChain filterChain) throws ServletException, IOException, GeoIp2Exception {
        ...
        try {
            ...
            log.info("{} {} m", request.getRemoteAddr() + "|<", duration);
//            logService.save(request, duration, response);
